...
import org.ism.charts.lib.util.CSVBuilder;
import org.ism.charts.lib.util.StringEncrypter;
...
public abstract class RequestContext {
    ...
    public static RequestContext getCurrentInstance() {
        ...
        // Our IChartsFacesContext therefore will only release our ThreadLocal cache
     ...
     *
     * @param expressions A string with one or multiple search expression to
     ...
     *
     * @param expressions A list with with one or multiple search expression to
     * resolve the components.
     */
    ...
    /**
     * @return Shared Client Side Validation builder instance of the current
     * request
     */
    ...
    /**
     * @return <code>true</code> if {@link AutoUpdatable} components should not
     * be updated automatically in this request.
     */
