...
import org.ism.charts.lib.behavior.base.AbstractBehavior;
import org.ism.charts.lib.component.api.AjaxSource;
...
@ResourceDependencies({ ///////  CSS
    ...
    @ResourceDependency(library = "vendor", name = "jquery/jquery.js")
    ,@ResourceDependency(library = "vendor", name = "jquery/jquery-plugins.js")
    ,@ResourceDependency(library = "ism", name = "icharts/core.js")
})
@FacesBehavior(value = AjaxBehavior.BEHAVIOR_ID)
public class AjaxBehavior extends AbstractBehavior implements AjaxSource {

    public static final String COMPONENT_TYPE = "org.ism.component.AjaxBehavior";
    public static final String COMPONENT_FAMILY = "org.ism.component";
    public static final String RENDERER_TYPE = "org.ism.renderKit.AjaxBehaviorRenderer";
    public final static String BEHAVIOR_ID = "org.ism.component.AjaxBehavior";
