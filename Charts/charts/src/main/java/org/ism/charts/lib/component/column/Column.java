 ...
 */
package org.ism.charts.lib.component.column;
...
public class Column extends UIColumn implements org.ism.charts.lib.component.api.UIColumn, org.ism.charts.lib.model.menu.MenuColumn {

    public static final String COMPONENT_TYPE = "org.ism.component.Column";
    public static final String COMPONENT_FAMILY = "org.ism.component";
    public static final String RENDERER_TYPE = "org.ism.renderKit.ColumnRenderer";
    public static final String DEFAULT_RENDERER = "org.ism.renderKit.ColumnRenderer";

    public enum PropertyKeys {

        sortBy, style, styleClass, sortFunction, filterBy, filterStyle, filterStyleClass, filterOptions, filterMatchMode, filterPosition, rowspan, colspan, headerText, footerText, selectionMode, filterMaxLength, resizable, exportable, filterValue, width, toggleable, filterFunction, field, priority, sortable, filterable, visible, selectRow, ariaHeaderText, exportFunction, groupRow;
