...
public class AjaxRequestBuilder {
    ...
    public AjaxRequestBuilder partialSubmit(boolean value, boolean partialSubmitSet, String partialSubmitFilter) {
        //IChartsConfiguration config = RequestContext.getCurrentInstance().getApplicationContext().getConfig();
        IChartsConfiguration config = new IChartsConfiguration(FacesContext.getCurrentInstance());
        //component can override global setting
        boolean partialSubmit = partialSubmitSet ? value : config.isPartialSubmitEnabled();
    ...
    private void addFragmentConfig() {
        ...
        Map<Object, Object> attrs = FacesContext.getCurrentInstance().getAttributes();//RequestContext.getCurrentInstance().getAttributes();
