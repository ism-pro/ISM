...
import org.ism.charts.lib.component.column.Column;
import org.ism.charts.lib.component.columngroup.ColumnGroup;
import org.ism.charts.lib.component.columns.Columns;
import org.ism.charts.lib.model.CollectionDataModel;
...
public class UIData extends javax.faces.component.UIData {
    ...
    protected void processColumnFacets(FacesContext context, PhaseId phaseId) {
        this.getChildren().stream().filter((child) -> (child.isRendered() && (child.getFacetCount() > 0))).forEachOrdered((child) -> {
