 ...
 */
package org.ism.charts.lib.config;
...
import org.ism.charts.lib.util.WebXmlParser;

/**
 *
 * @author r.hendrick
 */
public class IChartsConfiguration {

    private static final Logger LOG = Logger.getLogger(IChartsConfiguration.class.getName());
    ...
    protected IChartsConfiguration() {

    }

    public IChartsConfiguration(FacesContext context) {
    ...
    protected void initBuildProperties() {
        ...
        InputStream is = null;
        try {
            is = getClass().getResourceAsStream("/META-INF/maven/org.ism.charts/charts/pom.properties");
