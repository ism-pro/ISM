...
import org.ism.charts.lib.util.SharedStringBuilder;
...
public class SearchExpressionFacade {
    ...
    /**
     * Resolves a list of {@link UIComponent}s for the given expression or
     * expressions.
     *
    ...
    /**
     * Resolves a list of {@link UIComponent} clientIds and/or passtrough
     * expressions for the given expression or expressions.
     *
     * @param context The {@link FacesContext}.
     * @param source The source component. E.g. a button.
     * @param expressions The search expressions.
     * @return A {@link List} with resolved clientIds and/or passtrough
     * expression (like PFS, widgetVar).
     */
    ...
    /**
     * Resolves a {@link UIComponent} clientId and/or passtrough expression for
     * the given expression.
     *
     * @param context The {@link FacesContext}.
     * @param source The source component. E.g. a button.
     * @param expression The search expression.
     * @return A resolved clientId and/or passtrough expression (like PFS,
     * widgetVar).
     */
    ...
    /**
     * Validates the given search expression. We only validate it, for
     * performance reasons, if the current {@link ProjectStage} is
    ...
    /**
     * Validates the given search expressions. We only validate it, for
     * performance reasons, if the current {@link ProjectStage} is
     * {@link ProjectStage#Development}.
     *
     * @param context The {@link FacesContext}.
    ...
    /**
     * Splits the given string by the given separator, but ignoring separators
     * inside parentheses.
     *
     ...
     * {@link SearchExpressionResolver}, before rendering it to the client. e.g.
     * @all or @none.
     *
     * @param expression The search expression.
     * @return <code>true</code> if it should just be rendered without
     * manipulation or resolving.
     */
    ...
    /**
     * Checks if the given expression can be nested. e.g. @form:@parent This
     * should not be possible e.g. with @none or @all.
     *
     * @param expression The search expression.
