...
@NamedQueries({
    ...
    @NamedQuery(name = "DocExplorer.findByDcDesignationOfCompany", query = "SELECT d FROM DocExplorer d WHERE d.dcDesignation = :dcDesignation AND d.dcCompany = :dcCompany"),
    @NamedQuery(name = "DocExplorer.findByDcVersionOfCompany", query = "SELECT d FROM DocExplorer d WHERE d.dcVersion = :dcVersion AND d.dcCompany = :dcCompany"),
    @NamedQuery(name = "DocExplorer.findByDcLinkOfCompany", query = "SELECT d FROM DocExplorer d WHERE d.dcLink = :dcLink AND d.dcCompany = :dcCompany"),
