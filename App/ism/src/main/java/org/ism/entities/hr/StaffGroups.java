...
@NamedQueries({
    ...
    @NamedQuery(name = "StaffGroups.countStaffCompanyActivated", query = "SELECT count(s) FROM StaffGroups s WHERE s.stgCompany = :stgCompany AND s.stgStaff = :stgStaff AND s.stgActivated=1"),
    @NamedQuery(name = "StaffGroups.findByStaffCompanyActivated", query = "SELECT s FROM StaffGroups s WHERE s.stgCompany = :stgCompany AND s.stgStaff = :stgStaff AND s.stgActivated=1"),
    @NamedQuery(name = "StaffGroups.selectAllByLastChange", query = "SELECT s FROM StaffGroups s ORDER BY s.stgChanged DESC"),
    
    @NamedQuery(name = "StaffGroups.findByCompanyStaffMaillist", query = "SELECT s FROM StaffGroups s WHERE s.stgCompany = :stgCompany AND s.stgStaff.stMaillist = :stMaillist"),
