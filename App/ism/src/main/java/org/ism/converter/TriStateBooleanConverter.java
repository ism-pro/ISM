...
@ManagedBean
@SessionScoped
@FacesConverter(value = "triStateConverter")
public class TriStateBooleanConverter implements Converter , Serializable {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
        ...
        try {
            ...
            JsfUtil.out("TriStateConverter :  Impossible de convertir la valeur " + value + " en entier ! Erreur : " + ex.getLocalizedMessage());
            return null;
        }
