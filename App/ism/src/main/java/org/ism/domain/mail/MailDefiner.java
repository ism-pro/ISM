...
public class MailDefiner {
    ...
    public Boolean isStandardDefined(){
        return (!tosAsString().trim().isEmpty() || !ccsAsString().trim().isEmpty() || !ccisAsString().trim().isEmpty());
    }
    
    public Boolean isReclamDefined(){
        return (!tosReclamAsString().trim().isEmpty() || !ccsReclamAsString().trim().isEmpty() || !ccisReclamAsString().trim().isEmpty());
    }
